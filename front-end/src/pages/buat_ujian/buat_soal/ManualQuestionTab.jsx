...
export default function ManualQuestionTab(props) {
      ...
      <div className="w-full mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <div className="p-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <button
              onClick={addField}
              className="cursor-pointer w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded transition duration-200"
            >
              Tambah Field
            </button>
          </div>
