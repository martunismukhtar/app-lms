    ...
    >
      <div className="flex items-start">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-600 truncate">Wali Kelas : {kelas.nama_wali_kelas}</p>
          <p className="text-sm text-gray-600 truncate">Jumlah Siswa : {kelas.jumlah_siswa}</p>
